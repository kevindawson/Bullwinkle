...
use_ok( 'Bullwinkle::Server::Parameters', @subs );

foreach my $subs (@subs) {
	can_ok( 'Bullwinkle::Server::Parameters', $subs );
}

my @subs2 = qw( api file host port transport );
my $msg_com = Bullwinkle::Server::Parameters->new;
isa_ok( $msg_com, 'Bullwinkle::Server::Parameters' );
